    ...
    return (
        <div style={rootStyles}>
            ...
            <List>
                ...
                <ListItem button><ListItemText primary={<Typography className="font-weight-bold">V. Full House/First House: The Ticket with all its numbers struck first <Typography className="text-warning" display="inline">5$</Typography></Typography>}></ListItemText></ListItem>
